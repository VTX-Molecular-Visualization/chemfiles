...
TEST_CASE("Write mmCIF file") {
    ...
    "#\n"
    "_cell.length_a 22.0000\n"
    "_cell.length_b 22.0000\n"
    "_cell.length_c 22.0000\n"
    "_cell.length_alpha 90.0000\n"
    "_cell.length_beta  90.0000\n"
    "_cell.length_gamma 90.0000\n"
    "#\n"
    "loop_\n"
    ...
    "HETATM 1     A  A    .   . .    .    1.000    2.000    3.000    0.000 . 1\n"
    "ATOM   2     B  B    . foo ?    2    1.000    2.000    3.000    0.000 . 1\n"
    "ATOM   3     C  C    . foo ?    2    1.000    2.000    3.000    0.000 . 1\n"
    "HETATM 4     D  D    . bar G    ?    1.000    2.000    3.000    0.000 A 1\n"
    "HETATM 5     A  A    .   . .    .    4.000    5.000    6.000    0.000 . 2\n"
    "ATOM   6     B  B    . foo ?    2    1.000    2.000    3.000    0.000 . 2\n"
    "ATOM   7     C  C    . foo ?    2    1.000    2.000    3.000    0.000 . 2\n"
    "HETATM 8     D  D    . bar G    ?    1.000    2.000    3.000    0.000 A 2\n";
